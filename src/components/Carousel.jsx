...
const DEFAULT_ITEMS = [
  ...
  },
  {
    ...
    id: 2,
    icon: <FileCheck size={16} fill="white" />,
  },
  {
    ...
    id: 3,
    icon: <Building2 size={16} fill="white" />,
  },
  {
    ...
    <motion.div
      ...
      className={`relative shrink-0 flex flex-col ${
        round
          ...
          : "items-start justify-between bg-primary/10 border border-[#222] rounded-[12px]"
