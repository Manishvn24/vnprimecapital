  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute left-[-10%] top-0 h-87.5 w-87.5 rounded-full bg-primary/10 blur-3xl" />

        <div className="absolute bottom-0 right-[-10%] h-75 w-75 rounded-full bg-accent/10 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6">
        ...
        <div ref={ref} className="relative">
          {/* Vertical Line */}
          <div className="absolute left-7 top-0 h-full w-px bg-border md:left-1/2 md:-translate-x-1/2" />
          ...
          <motion.div
            ...
            className="absolute left-7 top-0 h-full w-px bg-primary md:left-1/2 md:-translate-x-1/2"
          />
