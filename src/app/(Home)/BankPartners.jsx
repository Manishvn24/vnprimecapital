    ...
    <div className="relative overflow-hidden">
      ...
      >
        {duplicatedBanks.map((bank, index) => (
          <div
            key={bank.name + index}
            className="group flex h-24 w-[220px] flex-shrink-0 items-center justify-center rounded-3xl border border-border/50 bg-card/40 px-8 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:bg-card/60"
          >
