          ...
          {loanProducts.map((product, index) => {
            ...
            return (
              <div
                ...
                } backdrop-blur-xl hover:-translate-y-2 hover:border-primary/40`}
                style={{
                  opacity: inView ? 1 : 0,
              ...
              >
                {/* Popular Badge */}
                {product.popular && (
                  <div className="absolute left-1/2 top-4 z-20 -translate-x-1/2 rounded-full bg-primary px-4 py-1 text-xs font-bold uppercase tracking-[0.2em] text-primary-foreground shadow-lg shadow-primary/30">
                    Most Popular
                  </div>
                )}
